...
class Step(BaseModel):
    ...
    execution_res: Optional[str] = Field(default=None, description="Execution result of the step")


class Plan(BaseModel):
    """Plan for the research task."""
    has_enough_context: bool = Field(description="Whether the plan has enough context to proceed")
